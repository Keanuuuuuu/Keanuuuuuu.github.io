window.__require = function e(t, a, i) {
	...
	for (var n = "function" == typeof __require && __require,
		...
		var a = {
			...
			gunNumLabAni: function(e, t, a, i, o) {
				if (void 0 === a && (a = 30), o = o || parseInt(e.string), t != o) {
					...
					s = Math.abs(t - o),
					c = o > t ? -1 : 1;
					Math.abs(t - o) > a && (s = a, c *= Math.abs(t - o) / a),
					e.node.runAction(cc.sequence(cc.callFunc(function() {
						n >= s - 1 ? e.string = i ? ToolsJs.getStrForNum2(t) : t: (o += Math.floor(c), e.string = i ? ToolsJs.getStrForNum2(o) : Math.floor(o)),
						n++
			...
			addNodeAni: function(e, t, a, i, o, n, s) {
				...
				u = o - i + 1,
				g = function(e) {
					cc.loader.loadRes(t + e, cc.SpriteFrame,
					function(t, i) {
						i && (d++, i.index = e, r.push(i)),
						d >= u && (ToolsJs.sortArrForObject(r, "index"), m.addClipForAnimaton(c, r, a, s, n))
					})
				},
				p = i; p <= o; p++) g(p)
			},
	...
	GameUiTools: [function(e, t) {
		...
		var a = {
			newSprite: function(e, t) {
				var a = new cc.Node;
				return t ? (e = e.split(".")[0], a.addComponent(cc.Sprite).spriteFrame = GameTools.love2048FrameCache.getSpriteFrame(e)) : a.addComponent(cc.Sprite).spriteFrame = new cc.SpriteFrame("res/raw-assets/resources/" + e),
				a
			},
			...
			setButtonClickEvents: function(e, t, a, i, o) {
				...
				for (var s = 0; s < n.length; s++) {
					...
					(null == o || o) && (r.transition = cc.Button.Transition.SCALE, r.duration = .1, r.zoomScale = 1.2)
				}
			},
			...
			loadingScene: function(e, t) {
				t ? cc.loader.loadRes("panel/LoadingLayer",
				function(t, a) {
	...
	HttpManagerJs: [function(e, t) {
		...
		a.clearAll = function() {
			for (var e = this.cacheList.length,
			t = 0; t < e; t++) {
	...
	LoadSceneJs: [function(e, t) {
		...
		var a = {
			goToCover: function(e, t, a, i, o) {
				...
				this.needShow = !1,
				n && n ? (this.needShow = !0, showMyAds()) : this.needShow = !1,
				this.needShow ? (null == preloader && this.startGoToGame(a, i, o), resCompleteFlag = !0, adCompleteFlag && resCompleteFlag && this.startGoToGame(a, i, o)) : this.startGoToGame(a, i, o)
			},
		...
		cc.Class({
			...
			onLoad: function() {
				...
				for (var t = 0; t < this.leafNode.children.length; t++) {
					...
					s = 200 * this.SizeScale * this.carmeraNode.getChildByName("MoveCamera").getComponent(cc.Camera).zoomRatio; (n.x > this.maxCameraMovePosX - s || n.x < -this.maxCameraMovePosX + s || n.y > this.maxCameraMovePosY - s || n.y < -this.maxCameraMovePosY + s) && (this.leafNode.children[t].opacity = 180)
				}
			...
			getCreatePos: function(e, t) {
				...
				for (var h = 0; h < this.leafNode.children.length; h++) if (s.pDistance(r, this.leafNode.children[h].position) < 400) return this.getCreatePos(e, t);
				return r
			},
			...
			CreateBianJie: function() {
				for (var e = 1; e < this.BGNum - 1; e++) if (e == Math.floor(this.BGNum / 2)) {
				...
				for (var i = 1; i < this.BGNum - 1; i++) if (i == Math.floor(this.BGNum / 2)) {
				...
				for (var s = 1; s < this.BGNum - 1; s++) if (s == Math.floor(this.BGNum / 2)) {
				...
				for (var h = 1; h < this.BGNum - 1; h++) if (h == Math.floor(this.BGNum / 2)) {
			...
			getEnemyPos: function(e, t) {
				if (void 0 === t && (t = 0), !this.gameOverFlags) {
					...
					if (this.firstFlags || (h = cc.v2(c, r)), ++t > 100) {
						...
						d = 0,
						u = 0;
						return l.x >= 0 && l.y >= 0 ? (d = -this.gameWidth / a, u = -this.gameHeight / a) : l.x < 0 && l.y >= 0 ? (d = this.gameWidth / a, u = -this.gameHeight / a) : l.x >= 0 && l.y < 0 ? (d = -this.gameWidth / a, u = this.gameHeight / a) : (d = this.gameWidth / a, u = this.gameHeight / a),
						cc.v2(m.x + d, m.y + u)
					}
					if (this.firstFlags) {
					...
					for (var y = 0; y < this.enemyNode.children.length; y++) if (s.pDistance(h, this.enemyNode.children[y].position) < 500) return this.getEnemyPos(e, t);
					return h
				}
			},
			...
			updateCreate: function() {
				console.log(this.playerNode.typeID)
			...
			judgeIsChange: function(e) {
				var t = this;
				if (this.tempArr.length >= 2) if (this.playerNode.typeID <= e) {
			...
			getSmallFishPos: function(e, t, a) {
				...
				for (var u = 0; u < n.children.length; u++) if (s.pDistance(o, n.children[u].position) < e.width / 2 * e.scaleX) return this.getSmallFishPos(e, t, a);
				return o
			},
			...
			JudgeSmallFish: function() {
				...
				this.playerNode.getChildByName("son").children.length > 0 ? (cc.audioEngine.play(this.HurtMusic, !1, 1), this.chooseBiggerFish()) : this.DieAction()
			},
			...
			removeSomeBigFish: function() {
				if (!this.gameOverFlags) {
					...
					for (var o = 0; o < a.length; o++) if (s.pDistance(e, a[o].position) > (this.gameHeight / 2 + a[o].height / 2) / t) return 8 == a[o].typeID && this.jingyuNum--,
			...
			removeSmallFish222: function() {
				...
				if (!this.gameOverFlags) {
					...
					if (! (this.playerNode.typeID >= 5)) {
						...
						if (i.length > 0) for (var n = function(o) {
							var n = i[o];
							n.runAction(cc.sequence(cc.delayTime(.05 * o), cc.callFunc(function(e) {
			...
			removeSmallFish: function() {
				if (!this.gameOverFlags) {
					...
					if (a.length > 0) for (var n = 0; n < a.length; n++) if (s.pDistance(e, a[n].position) > (this.gameHeight / 2 + a[n].height / 2) / t) return Math.random(),
			...
			createLizi: function(e, t) {
				...
				for (var n = this.carmeraNode.getChildByName("MoveCamera").getComponent(cc.Camera).zoomRatio, c = s.getRandomNum(15, 25, !0), r = s.getRandomNum(0, .05, !1), h = 0; h < c; h++) {
					...
					m.runAction(cc.sequence(cc.delayTime(r), cc.spawn(cc.moveTo(f, p).easing(cc.easeQuarticActionOut()), cc.scaleTo(f, u, u)), cc.fadeOut(.5), cc.callFunc(function() {},
					this), cc.removeSelf()))
				}
				for (var y = s.getRandomNum(10, 20, !0), v = 0; v < y; v++) {
					...
					S.runAction(cc.sequence(cc.delayTime(r), cc.spawn(cc.moveTo(P, M).easing(cc.easeQuarticActionOut()), cc.scaleTo(P, A, A)), cc.spawn(cc.rotateBy(.5, F), cc.fadeOut(.5)), cc.callFunc(function() {},
					this), cc.removeSelf()))
				}
			},
			...
			StoneFadeInAction: function() {
				...
				for (var i = s.getRandomNum(50, 100, !1), o = Math.floor(i / 2), n = 0; n < i; n++) {
					...
					} else c = cc.instantiate(this.liziPre),
					...
					S = [f, y, d];
					c.runAction(cc.sequence(cc.delayTime(v), cc.spawn(cc.bezierTo(N, S).easing(cc.easeQuadraticActionOut()), cc.scaleTo(N, u, u).easing(cc.easeBounceOut())), cc.spawn(cc.rotateBy(p, g), cc.fadeOut(p)), cc.callFunc(function() {},
					this), cc.removeSelf()))
				}
			...
			SummonDragonAction: function() {
				...
				for (var t = this.playerNode.getChildByName("son"), a = t.convertToNodeSpaceAR(this.playerNode.convertToWorldSpaceAR(this.myFish.position)), i = 0; i < t.children.length; i++) {
					...
					t.children[i].runAction(cc.sequence(cc.spawn(cc.jumpTo(.5, a, o, 1).easing(cc.easeQuadraticActionOut()), cc.scaleTo(.5, 0, 0), cc.rotateTo(0, 1, c)), cc.callFunc(function() {},
					this), cc.removeSelf()))
				}
				this.scheduleOnce(function() {
					e.StoneFadeInAction()
			...
			CreatePanLong: function() {
				...
				this)), cc.delayTime(.3), cc.callFunc(function() {
					l.runAction(cc.sequence(cc.scaleTo(.3, 1, 1), cc.callFunc(function() {},
					this)))
				},
				this), cc.delayTime(.6), cc.callFunc(function() {
					...
					n.runAction(cc.scaleTo(.5, .6 * this.SizeScale, .6 * this.SizeScale).easing(cc.easeBackOut()), cc.callFunc(function() {},
					this));
					...
					c.runAction(cc.sequence(cc.spawn(cc.fadeIn(.3), cc.moveTo(.3, r)), cc.callFunc(function() {},
					this))),
					this.scheduleOnce(function() {
						h.canTouchReplay = !0,
				...
				this.scheduleOnce(function() {
					e.stoneNode.runAction(cc.sequence(cc.spawn(cc.scaleBy(.5, .8 * e.SizeScale, .8 * e.SizeScale), cc.moveTo(.5, 0, e.gameHeight / 6).easing(cc.easeBackOut()), cc.callFunc(function() {
						l.runAction(cc.sequence(cc.moveTo(.5, 0, this.gameHeight / 6).easing(cc.easeBackOut()), cc.callFunc(function() {},
						this)))
					},
					e)), cc.callFunc(function() {},
					e))),
					e.scheduleOnce(function() {
						l.runAction(cc.sequence(cc.rotateBy(10, 360), cc.callFunc(function() {},
						e)).repeatForever())
					},
					.5),
					t.runAction(cc.sequence(cc.spawn(cc.scaleTo(.5, .9 * e.SizeScale, .9 * e.SizeScale), cc.moveTo(.5, -50 * e.SizeScale, e.gameHeight / 6 - 370 * e.SizeScale).easing(cc.easeBackOut())), cc.callFunc(function() {},
					e)))
				},
				1.3),
				this.scheduleOnce(function() {
					...
					t.runAction(cc.sequence(cc.rotateBy(2, 10), cc.callFunc(function() {},
					e)).repeatForever()),
					a.runAction(cc.sequence(cc.rotateBy(1, -10), cc.callFunc(function() {},
					e)).repeatForever()),
					i.runAction(cc.sequence(cc.rotateBy(.5, 10), cc.callFunc(function() {},
					e)).repeatForever())
				},
				1.8),
				this.scheduleOnce(function() {
			...
			update: function(e) {
				if (this.updateCreate(), this.removeSmallFish(), this.removeSomeBigFish(), this.playerNode.typeID, this.waterCount++, this.waterCount > this.randnum && (this.WaterAction(), this.waterCount = 0, this.randnum = s.getRandomNum(20, 40, !0)), this.OffPos) {
					...
					if (i.children.length >= 1) for (var o = 0; o < i.children.length; o++) this.updateFishRotate(i.children[o], this.angle, this.rotSpeed * e);
					this.CameraMove(e)
				}
			...
			gameEnd1: function() {
				...
				this.gameOverT1.node.runAction(cc.sequence(cc.delayTime(.2), cc.spawn(cc.fadeIn(.5), cc.moveBy(.5, 0, -50)), cc.callFunc(function() {},
				this), cc.callFunc(function() {
					e.canTouch = !0
				},
				this))),
	...
	MainManage: [function(e, t) {
		...
		c = {
			...
			getHttpGameId: function() {
				...
				var r = e.substring(e.lastIndexOf("//") + 4, e.lastIndexOf("com") + 3); - 1 == e.search("/game/") ? this.moreGameUrl = t + a: this.moreGameUrl = t + r,
			...
			initLanguage: function() {
				var e = null;
				return cc.sys.language == cc.sys.LANGUAGE_CHINESE ? (this.curType = 1, e = i.language_1) : (cc.log("\u82f1\u6587"), this.curType = 2, e = i.language_2),
				e
			},
	...
	OtherConfig: [function(e, t) {
		...
		var a = {
			...
			getStrForType: function(e) {
				...
				null != this[e] ? this[e][t] : (cc.log("\u6ca1\u6709\u7ffb\u8bd1:" + e), e)
			}
		};
	...
	ToolsJs: [function(e, t) {
		...
		var a = {
			...
			newSprite: function(e, t) {
				var a = new cc.Node;
				return null != this.SpriteFrameDic[e] ? (a.addComponent(cc.Sprite).spriteFrame = this.SpriteFrameDic[e], null != t && t(a)) : (a.addComponent(cc.Sprite), loadTools.loadNodeSprite(a, e, t)),
				a
			},
			...
			setBtnClickSpr: function(e, t, a, i) {
				this.SpriteFrameDic[t] ? (e.getComponent(cc.Button).normalSprite = this.SpriteFrameDic[t], e.getComponent(cc.Button).hoverSprite = this.SpriteFrameDic[t], e.getComponent(cc.Sprite).pressedSprite = this.SpriteFrameDic[a], null != i && i()) : (loadTools.getResSpr(t,
				function(t) {
					e.getComponent(cc.Button).normalSprite = t,
					e.getComponent(cc.Button).hoverSprite = t
				}), loadTools.getResSpr(a,
				function(t) {
			...
			setSpriteState: function(e, t) {
				...
				cc.loader.loadRes("materials/" + a, cc.Material,
				function(t, a) {
			...
			clonePrefab: function(e, t, a, i, o) {
				...
				s = null;
				return null != n ? (s = cc.instantiate(n), t && t.addChild(s, o), a && (s.position = a), null != i && i(s)) : loadTools.loadPrefab(e, t, a, i, o),
				s
			},
			...
			writeJson: function(e, t) {
				if (cc.sys.isBrowser) {
					...
					null != window.webkitURL ? i.href = window.webkitURL.createObjectURL(a) : (i.href = window.URL.createObjectURL(a), i.onclick = destroyClickedElement, i.style.display = "none", document.body.appendChild(i)),
					i.click()
				}
			}
		};
	...
	UIManager: [function(e, t) {
		...
		var a = {
			...
			OpenUI: function(e, t, a) {
				...
				i && i[e] && (o = i[e]),
				null != o ? null == this.UIDic[e] ? (1 == a && this.removeAllUI(), this.CreateUI(o, t)) : cc.error("\u5df2\u7ecf\u6253\u5f00\u8fc7UI:" + e) : cc.error("\u672a\u627e\u5230\u8be5UI\u7684\u914d\u7f6e\u4fe1\u606f:" + e)
			},
			CloseUI: function(e, t) {
				var a;
				"string" == typeof e || (e = e.name),
				null != (a = this.UIDic[e]) ? (a.getComponent(a.config.com) && null != a.getComponent(a.config.com).closeUI ? a.getComponent(a.config.com).closeUI(t) : a.destroy(), this.UIDic[e] = null) : cc.error("\u5df2\u7ecf\u5173\u95ed\u8fc7UI:" + e)
			},
			GetUI: function(e) {
				var t = this.UIDic[e];
			...
			CreateUI: function(e, t) {
				...
				if (null == this.UIDic[e.name]) {
					...
					ToolsJs.clonePrefab(e.resUrl, i, null,
					function(i) {
						i.config = e;
	...
	audioTools: [function(e, t) {
		...
		var a = {
			...
			playBG: function(e, t) {
				void 0 === t && (t = .3),
				this.isPlayBG && this.isPlayAudio && (this.stopBG(), null != ToolsJs.AudioClipDic[e] ? this.bgAudio = cc.audioEngine.play(ToolsJs.AudioClipDic[e], !0, t) : this.bgAudio = cc.audioEngine.play(cc.url.raw("resources/music/" + e + ".mp3"), !0, t))
			},
			stopBG: function() {
		...
		cc.Class({
			...
			clickEnterOverLayer: function() {
				if (this.node.canTouch && (this.node.canTouch = !1, a.publicGameBool || adBreak({
					type: "next",
					name: "restart-game"
				}), this.mainSelf.initEndLayer(), this.mainSelf.gameOverT1.node.destroy(), this.mainSelf.gameOverT2.node.destroy(), this.mainSelf.enemyNode.children.length > 0)) for (var e = 0; e < this.mainSelf.enemyNode.children.length; e++) this.mainSelf.enemyNode.children[e].typeID >= this.mainSelf.maxTypeID && this.mainSelf.enemyNode.children[e].destroy()
			},
			start: function() {},
			update: function() {}
		}),
	...
	gameOverJs: [function(e, t) {
		...
		cc.Class({
			...
			onLoad: function() {
				...
				n = this.getHighScore();
				n ? n < this.mainSelf.maxTypeID && (this.setHisSocre(this.mainSelf.maxTypeID), n = this.mainSelf.maxTypeID) : (this.setHisSocre(this.mainSelf.maxTypeID), n = o),
				this.typeID = n,
				this.endPageDisplay(),
			...
			addClickBtns: function() {
				var e = this;
				e.moreBtn.node.on(cc.Node.EventType.TOUCH_START,
				function() {}),
				e.moreBtn.node.on(cc.Node.EventType.TOUCH_END,
				function() {
					console.log("MoreGame"),
					window.location.href = o.moreGameUrl
				}),
				e.leftBtn.node.on(cc.Node.EventType.TOUCH_START,
				function() {}),
				e.leftBtn.node.on(cc.Node.EventType.TOUCH_END,
				function() {
	...
	loadTools: [function(e, t) {
		...
		var a = {
			loadNodeSprite: function(e, t, a) {
				e.getComponent(cc.Sprite) ? cc.loader.loadRes(t, cc.SpriteFrame,
				function(t, i) {
	...
	mTool_WHQ: [function(e, t) {
		...
		var a = {
			...
			worldPosToCbPos: function(e, t, a, i, o, n) {
				var s = (e.x - a) / o - .5 + t / 2,
				c = (e.y - i) / n - .5;
				return s % 1 == 0 && c % 1 == 0 || (s = Math.round(s), c = Math.round(c)),
				cc.v2(s, c)
			},
			...
			judgeArrSame: function(e, t) {
				for (var a = 0; a < e.length; a++) for (var i = 0; i < t.length; i++) if (e[a] !== t[i]) return ! 1;
				return ! 0
			},
	...
	rockerJS: [function(e, t) {
		...
		cc.Class({
			...
			onLoad: function() {
				...
				this.mainSelf.node.on(cc.Node.EventType.TOUCH_END,
				function() {
					this.buttonNode.setPosition(cc.v2(0, 0))
				},
				this),
				this.mainSelf.node.on(cc.Node.EventType.TOUCH_CANCEL,
				function() {
					this.buttonNode.setPosition(cc.v2(0, 0))
				},
				this),
				this.mainSelf.node.on(cc.Node.EventType.TOUCH_MOVE,
				function(e) {
					var t = e.getLocation(),
					a = this.node.convertToNodeSpaceAR(t),
					i = a.mag();
					this.dir.x = a.x / i,
					this.dir.y = a.y / i,
					i > this.max_r && (a.x = a.x / i * this.max_r, a.y = a.y / i * this.max_r),
					this.dir.mag() > .5 && i > 0 && (this.mainSelf.OffPos = this.dir),
					this.buttonNode.setPosition(a)
				},
				this),
				this.mainSelf.node.on(cc.Node.EventType.TOUCH_START,
				function(e) {
					var t = e.getLocation(),
